    ...
    <div className="text-white mb-[48px]">
      ...
      <div className="container-info px-4 rounded-[20px] bg-[#ffffff14]">
        {elemetsVisibleByPage.map((item) => (
          <div className="container-info-user flex items-center justify-between py-[16px] border-b border-solid border-[#ffffff14]" key={item.id}>
            ...
            <div className="container-right">
              ...
              <p className={`text-[12px] ${item.status === "Active" ? "text-[#20DABB]" : "text-[#FF4C5A]"}`}>{item.status}</p>
            </div>
          </div>
        ))}
      </div>
